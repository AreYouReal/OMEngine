...
class ShaderHelper {
public:
    static sp<ShaderProgram>    createProgram(string vFileName, string fFileName);
    static sp<ShaderProgram>    createProgram(const Shader &vertex, const Shader &fragment);
